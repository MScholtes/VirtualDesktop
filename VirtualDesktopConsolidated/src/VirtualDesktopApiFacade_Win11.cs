...
{
    public class VirtualDesktopApiFacade_Win11 : IVirtualDesktopApiFacade
    {
        private readonly IVirtualDesktopManagerInternal_Win11 _managerInternal;
        private readonly IVirtualDesktopManager_Win11 _manager;
        private readonly IApplicationViewCollection_Win11 _viewCollection;
        private readonly IVirtualDesktopPinnedApps_Win11 _pinnedApps;

        public VirtualDesktopApiFacade_Win11()
        {
            ...
            Guid iid = typeof(IVirtualDesktopManagerInternal_Win11).GUID;
            IntPtr ppv;
            int hr = shell.QueryService(ref serviceGuid, ref iid, out ppv);
            if (hr != 0 || ppv == IntPtr.Zero)
                throw new InvalidCastException("QueryService did not return IVirtualDesktopManagerInternal_Win11");
            _managerInternal = (IVirtualDesktopManagerInternal_Win11)Marshal.GetObjectForIUnknown(ppv);
            _manager = (IVirtualDesktopManager_Win11)Activator.CreateInstance(Type.GetTypeFromCLSID(new Guid("AA509086-5CA9-4C25-8F95-589D3C07B48A")));
            iid = typeof(IApplicationViewCollection_Win11).GUID;
            hr = shell.QueryService(ref iid, ref iid, out ppv);
            if (hr != 0 || ppv == IntPtr.Zero)
                throw new InvalidCastException("QueryService did not return IApplicationViewCollection_Win11");
            _viewCollection = (IApplicationViewCollection_Win11)Marshal.GetObjectForIUnknown(ppv);
            serviceGuid = new Guid("B5A399E7-1C87-46B8-88E9-FC5747B171BD");
            iid = typeof(IVirtualDesktopPinnedApps_Win11).GUID;
            hr = shell.QueryService(ref serviceGuid, ref iid, out ppv);
            if (hr != 0 || ppv == IntPtr.Zero)
                throw new InvalidCastException("QueryService did not return IVirtualDesktopPinnedApps_Win11");
            _pinnedApps = (IVirtualDesktopPinnedApps_Win11)Marshal.GetObjectForIUnknown(ppv);
        }
        ...
        public int GetCurrentDesktopIndex()
        {
            ...
            {
                desktops.GetAt(i, typeof(IVirtualDesktop_Win11).GUID, out var obj);
                if (((IVirtualDesktop_Win11)obj).GetId() == current.GetId())
                    return i;
            }
            return -1;
        }
        ...
        public void SwitchDesktop(int index)
        {
            ...
            desktops.GetAt(index, typeof(IVirtualDesktop_Win11).GUID, out var obj);
            _managerInternal.SwitchDesktop((IVirtualDesktop_Win11)obj);
        }
        ...
        public void RemoveDesktop(int index, int fallbackIndex)
        {
            ...
            desktops.GetAt(index, typeof(IVirtualDesktop_Win11).GUID, out var objRemove);
            desktops.GetAt(fallbackIndex, typeof(IVirtualDesktop_Win11).GUID, out var objFallback);
            _managerInternal.RemoveDesktop((IVirtualDesktop_Win11)objRemove, (IVirtualDesktop_Win11)objFallback);
        }
        ...
        {
            _managerInternal.GetDesktops(out var desktops);
            desktops.GetAt(index, typeof(IVirtualDesktop_Win11).GUID, out var objDesktop);
            try { return ((IVirtualDesktop_Win11)objDesktop).GetName(); } catch { return $"Desktop {index + 1}"; }
        }
        ...
        public void SetDesktopName(int index, string name)
        {
            _managerInternal.GetDesktops(out var desktops);
            desktops.GetAt(index, typeof(IVirtualDesktop_Win11).GUID, out var objDesktop);
            _managerInternal.SetDesktopName((IVirtualDesktop_Win11)objDesktop, name);
        }
        ...
        public void SetDesktopWallpaper(int index, string path)
        {
            _managerInternal.GetDesktops(out var desktops);
            desktops.GetAt(index, typeof(IVirtualDesktop_Win11).GUID, out var objDesktop);
            _managerInternal.SetDesktopWallpaper((IVirtualDesktop_Win11)objDesktop, path);
        }
        ...
        public void MoveWindowToDesktop(IntPtr hWnd, int desktopIndex)
        {
            ...
            _managerInternal.GetDesktops(out var desktops);
            desktops.GetAt(desktopIndex, typeof(IVirtualDesktop_Win11).GUID, out var objDesktop);
            int processId;
            ...
            if (Process.GetCurrentProcess().Id == processId)
            {
                try
                {
                    _manager.MoveWindowToDesktop(hWnd, ((IVirtualDesktop_Win11)objDesktop).GetId());
                }
                catch
                {
                    _viewCollection.GetViewForHwnd(hWnd, out var view);
                    _managerInternal.MoveViewToDesktop(view, (IVirtualDesktop_Win11)objDesktop);
                }
            }
            else
            {
        ...
        public bool IsWindowOnDesktop(IntPtr hWnd, int desktopIndex)
        {
            ...
            return ((IVirtualDesktop_Win11)objDesktop).GetId() == id;
        }
        ...
        public int GetLeftDesktopIndex(int index)
        {
            _managerInternal.GetDesktops(out var desktops);
            desktops.GetAt(index, typeof(IVirtualDesktop_Win11).GUID, out var objDesktop);
            int hr = _managerInternal.GetAdjacentDesktop((IVirtualDesktop_Win11)objDesktop, 3, out var leftDesktop); // 3 = LeftDirection
            if (hr == 0)
            {
                for (int i = 0; i < GetDesktopCount(); i++)
                {
                    desktops.GetAt(i, typeof(IVirtualDesktop_Win11).GUID, out var obj);
                    if (((IVirtualDesktop_Win11)obj).GetId() == leftDesktop.GetId())
                        return i;
                }
            }
            return -1;
        ...
        public int GetRightDesktopIndex(int index)
        {
            _managerInternal.GetDesktops(out var desktops);
            desktops.GetAt(index, typeof(IVirtualDesktop_Win11).GUID, out var objDesktop);
            int hr = _managerInternal.GetAdjacentDesktop((IVirtualDesktop_Win11)objDesktop, 4, out var rightDesktop); // 4 = RightDirection
            if (hr == 0)
            {
                for (int i = 0; i < GetDesktopCount(); i++)
                {
                    desktops.GetAt(i, typeof(IVirtualDesktop_Win11).GUID, out var obj);
                    if (((IVirtualDesktop_Win11)obj).GetId() == rightDesktop.GetId())
                        return i;
                }
            }
            return -1;
